...
def read_file(path, manufacturer, fmt, **options):
    """
    ...
    if manufacturer == 'smsdvs' and fmt == 'xlsx':
        from .sms_dvs_excel import parse_file
    elif manufacturer == 'mic' and fmt == 'xl':
        from .mic_excel import parse_file
    elif manufacturer == 'bel':
        if fmt == 'xl':
            from .bel_excel import parse_file
        elif fmt == 'csv':
            from .bel_csv import parse_file
        elif fmt == 'dat':
            from .bel_dat import parse_file
...
def read(content, manufacturer, fmt, **options):
    """
    Parse file contents generated by commercial apparatus.
