...
def read(path, manufacturer, fmt, **options):
    """
    Parse a file generated by commercial instrument.
    ...
    meta['filetype'] = manufacturer
    return meta, data


def write_aif(path, meta, data):
    """
    Create an AIF file from the original dictionary.
    ...
    """
    from .aif import make_aif
    make_aif(path, meta, data)
